...
import { ImageOptionCard } from '../../components/exercise/ImageOptionCard';
...
interface RecognitionExerciseProps {
  theme: SkillTheme;
  skillTitle: string;
  level: number;
  word: string;
    ...
    <SafeAreaView style={styles.root} edges={['top']}>
      ...
      >
        ...
        <View style={styles.prompt}>
          <Text style={styles.promptTitle}>Choose the image that matches the word</Text>
