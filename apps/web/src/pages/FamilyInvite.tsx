...
/** Must match the mobile route and the API's APP_INVITE_URL default. */
const APP_SCHEME_URL = 'lexiroot://family-invite';

/**
 * Bridge page for family invitation emails.
 *
...
export function FamilyInvite() {
  ...
  return (
    <Shell title="You've been invited to a family plan">
      {attempted ? (
        <>
          <p className="max-w-sm text-sm text-neutral-variant">
            Install LexiRoot, then open this link again on your phone to accept. You'll get your own
            account — your own languages, streak and progress. Only the plan is shared.
          </p>
