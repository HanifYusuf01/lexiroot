...
const STORAGE_KEY = 'lexiroot.admin.users.recent-searches';
const MAX_RECENT = 5;
...
interface Props {
  ...
  /** Fires when the user "commits" a search (Enter key, blur, or pick from recents). */
  onCommit?: (value: string) => void;
}

export function SearchPopover({ value, onChange, onCommit }: Props) {
